...
class InvitationsService {
	 ...
	 */
	async updateStatus(userWorkspaceId: string, data: UpdateInvitationDto): Promise<Invitation> {
		return apiClient.put<Invitation>(API_ENDPOINTS.invitations.byId(userWorkspaceId), data)
	}
