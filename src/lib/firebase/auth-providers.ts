...
export const AUTH_PROVIDERS: Record<SocialProviderName | string, AuthProviderConfig> = {
	google: {
		...
		getAccessToken: (result) =>
			GoogleAuthProvider.credentialFromResult(result)?.accessToken || undefined,
	},
	'google.com': {
		id: 'google.com',
		name: 'Google',
	...
	github: {
		...
		getAccessToken: (result) =>
			GithubAuthProvider.credentialFromResult(result)?.accessToken || undefined,
	},
	'github.com': {
		id: 'github.com',
		name: 'GitHub',
	...
	microsoft: {
		...
		getAccessToken: (result) =>
			OAuthProvider.credentialFromResult(result)?.accessToken || undefined,
	},
}
