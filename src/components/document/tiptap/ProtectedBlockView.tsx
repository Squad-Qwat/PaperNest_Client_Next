		...
		<NodeViewWrapper
			...
			style={{
				border: validation.valid
					? '1px dashed var(--primary-subtle, #93c5fd)'
					: '1px solid var(--danger, #ef4444)',
				background: validation.valid
					? 'var(--info-subtle, #eff6ff)'
					: 'var(--danger-subtle, #fef2f2)',
				borderRadius: 'var(--radius-md, 6px)',
				padding: '12px',
				margin: '16px 0',
				boxShadow: selected
					? '0 0 0 2px var(--primary, rgba(59,130,246,0.35))'
					: 'var(--shadow-sm)',
		...
		>
			...
			>
				<div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
					<strong
						style={{ textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--primary)' }}
					>
						{blockType}
					</strong>
					<span
						style={{
							...
							width: '4px',
							borderRadius: '50%',
							background: validation.valid ? 'var(--success, #10b981)' : 'var(--danger, #ef4444)',
						}}
					/>
				</div>
				<span
