...
import { Bold, Heading1, Heading2, Italic, List, Quote, Sigma } from 'lucide-react'
...
import { MathLiveBlockNode, MathLiveNode } from '../tiptap/MathLiveExtension'
						...
						<MenuButton
							onClick={() =>
								editor
									.chain()
									.focus()
									.insertContent('<span data-type="math" data-latex="">$$</span>')
									.run()
							}
