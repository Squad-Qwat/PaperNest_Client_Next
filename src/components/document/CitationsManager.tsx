...
interface FormData extends Omit<Citation, 'id' | 'index'> {}
...
// Main Component
export function CitationsManager({ isOpen, onClose, citations, onCitationsChange, initialView = 'list', onInsert }: CitationsManagerProps) 
{
