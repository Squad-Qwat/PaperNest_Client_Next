			...
			<div className='flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10'>
				<div className='space-y-3'>
					...
					<div className='flex flex-wrap items-center gap-2 text-sm'>
						<Badge
							variant='secondary'
							className='font-medium px-2.5 py-0.5 flex items-center gap-1.5 bg-muted text-muted-foreground border-none'
						>
						...
						<Button
							variant='link'
							size='sm'
							className={`h-auto p-0 font-bold ${isDeleted ? 'text-muted-foreground cursor-not-allowed' : 'text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300'}`}
