			...
			<div className='flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10'>
				<div className='space-y-3'>
					...
					<div className='flex flex-wrap items-center gap-2 text-sm'>
						<Badge
							variant='secondary'
							className='font-medium px-2.5 py-0.5 flex items-center gap-1.5 bg-gray-100 text-gray-600 border-none'
						>
							<UserIcon className='w-3 h-3' />
							<span>
								Oleh <span className='font-bold text-gray-900'>{studentName}</span>
							</span>
						</Badge>
						<Badge
							variant='secondary'
