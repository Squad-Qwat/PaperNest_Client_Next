...
mxRackF5BigIp1600.prototype.paintVertexShape = function (c, x, y, w, h) {
	...
	var psNum = parseInt(mxUtils.getValue(this.style, 'psNum', '2'), 10)
		...
		if (isDC) {
			if (psNum >= '1') {
				c.image(
					...
					w * 0.244,
					h * 0.92,
					`${stencilPath}big_ip_4x00_dc.png`,
					0,
					0,
					0
				)
			...
			if (psNum >= '2') {
				c.image(
					...
					w * 0.245,
					h * 0.92,
					`${stencilPath}big_ip_4x00_ac.png`,
					0,
					0,
					0
				)
...
mxRackF5BigIp6900.prototype.paintVertexShape = function (c, x, y, w, h) {
	...
	var isFront = mxUtils.getValue(this.style, 'isFront', '0')
	var isDC = mxUtils.getValue(this.style, 'isDC', '0')
	var _psNum = parseInt(mxUtils.getValue(this.style, 'psNum', '2'), 10)
	var stencilPath = mxUtils.getValue(this.style, 'path', 'img/lib/f5/')
	...
	if (isFront) {
		...
		if (isDC) {
			c.image(
				...
				w * 0.176,
				h * 0.48,
				`${stencilPath}big_ip_6900_dc.png`,
				0,
				0,
				0
			)
...
mxCellRenderer.registerShape(
	mxRackF5BigIp10x00.prototype.cst.SHAPE_BIG_IP_10x00,
	mxRackF5BigIp10x00
)
...
mxCellRenderer.registerShape(
	mxRackF5BigIp110x0.prototype.cst.SHAPE_BIG_IP_110x0,
	mxRackF5BigIp110x0
)
...
mxRackF5Viprion2400.prototype.paintVertexShape = function (c, x, y, w, h) {
	...
	var isFront = mxUtils.getValue(this.style, 'isFront', '0')
	var isDC = mxUtils.getValue(this.style, 'isDC', '0')
	var bladeNum = parseInt(mxUtils.getValue(this.style, 'bladeNum', '4'), 10)
	var stencilPath = mxUtils.getValue(this.style, 'path', 'img/lib/f5/')
	...
	if (isFront) {
		...
		if (isDC) {
			c.image(
				...
				w * 0.301,
				h * 0.273,
				`${stencilPath}viprion_2400_dc.png`,
				0,
				0,
				0
			)
		...
		if (bladeNum >= 1) {
			c.image(
				...
				w * 0.45,
				h * 0.29,
				`${stencilPath}viprion_2400_blade.png`,
				0,
				0,
				0
			)
...
mxCellRenderer.registerShape(
	mxRackF5Viprion2400.prototype.cst.SHAPE_VIPRION_2400,
	mxRackF5Viprion2400
)
...
mxRackF5Viprion4400.prototype.paintVertexShape = function (c, x, y, w, h) {
	...
	var isDC = mxUtils.getValue(this.style, 'isDC', '0')
	var bladeNum = parseInt(mxUtils.getValue(this.style, 'bladeNum', '0'), 10)
	var stencilPath = mxUtils.getValue(this.style, 'path', 'img/lib/f5/')
	...
	if (isFront) {
		...
		if (hasMask) {
			c.image(
				...
				w * 0.934,
				h * 0.282,
				`${stencilPath}viprion_4400_front.png`,
				0,
				0,
				0
			)
...
mxCellRenderer.registerShape(
	mxRackF5Viprion4400.prototype.cst.SHAPE_VIPRION_4400,
	mxRackF5Viprion4400
)
	...
	if (isFront) {
		...
		if (bladeNum >= 1) {
			c.image(
				...
				w * 0.104,
				h * 0.516,
				`${stencilPath}viprion_4800_blade.png`,
				0,
				0,
				0
			)
...
mxCellRenderer.registerShape(
	mxRackF5Viprion4800.prototype.cst.SHAPE_VIPRION_4800,
	mxRackF5Viprion4800
)
...
mxCellRenderer.registerShape(
	mxRackF5BigIpi2000.prototype.cst.SHAPE_BIG_IP_I2000,
	mxRackF5BigIpi2000
)
...
mxCellRenderer.registerShape(
	mxRackF5BigIpi4000.prototype.cst.SHAPE_BIG_IP_I4000,
	mxRackF5BigIpi4000
)
...
mxCellRenderer.registerShape(
	mxRackF5BigIpi5000.prototype.cst.SHAPE_BIG_IP_I5000,
	mxRackF5BigIpi5000
)
...
mxCellRenderer.registerShape(
	mxRackF5BigIpi7000.prototype.cst.SHAPE_BIG_IP_I7000,
	mxRackF5BigIpi7000
)
...
mxCellRenderer.registerShape(
	mxRackF5BigIpi10000.prototype.cst.SHAPE_BIG_IP_I10000,
	mxRackF5BigIpi10000
)
...
Draw.loadPlugin((ui) => {
	...
	var fns = [
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_1600;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'Big-IP 1600',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_1600;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'Big-IP 1600',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_2x00;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'Big-IP 2x00',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_2x00;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'Big-IP 2x00',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_3600;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'Big-IP 3600',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_3600;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'Big-IP 3600',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_3900;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'Big-IP 3900',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_3900;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'Big-IP 3900',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_4x00;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'Big-IP 4x00',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_4x00;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'Big-IP 4x00',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_5x00;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'Big-IP 5x00',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_5x00;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'Big-IP 5x00',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.em4000;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'EM 4000',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.em4000;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'EM 4000',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_6900;hasEars=0;isFront=1;isDC=0;`,
			168,
			32,
			'',
			'Big-IP 6900',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_6900;hasEars=1;isFront=0;isDC=1;`,
			168,
			32,
			'',
			'Big-IP 6900',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_89x0;hasEars=0;isFront=1;isDC=0;`,
			168,
			32,
			'',
			'Big-IP 89x0',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_7x00;hasEars=0;isFront=1;isDC=0;`,
			168,
			32,
			'',
			'Big-IP 7x00',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_7x00;hasEars=1;isFront=0;isDC=1;`,
			168,
			32,
			'',
			'Big-IP 7x00',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_10x00;hasEars=0;isFront=1;isDC=0;`,
			168,
			32,
			'',
			'Big-IP 10x00',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_10x00;hasEars=1;isFront=0;isDC=1;`,
			168,
			32,
			'',
			'Big-IP 10x00',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_110x0;hasEars=0;isFront=1;isDC=0;`,
			168,
			48,
			'',
			'Big-IP 110x0',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_110x0;hasEars=1;isFront=0;isDC=1;`,
			168,
			48,
			'',
			'Big-IP 110x0',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.viprion_2400;hasEars=0;isFront=1;isDC=1;bladeNum=4;`,
			168,
			64,
			'',
			'VIPRION 2400',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.viprion_2400;hasEars=1;isFront=0;isDC=0;bladeNum=4;`,
			168,
			64,
			'',
			'VIPRION 2400',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.viprion_4400;hasMask=1;bladeType=0;hasEars=0;isFront=1;isDC=1;bladeNum=4;`,
			168,
			112,
			'',
			'VIPRION 4400',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.viprion_4400;hasMask=1;bladeType=0;hasEars=1;isFront=0;isDC=0;bladeNum=4;`,
			168,
			112,
			'',
			'VIPRION 4400',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.viprion_4800;hasEars=1;isFront=1;bladeNum=8;`,
			168,
			224,
			'',
			'VIPRION 4800',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.viprion_4800;hasEars=0;isFront=0;bladeNum=8;`,
			168,
			224,
			'',
			'VIPRION 4800',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_i2000;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'Big-IP i2000',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_i2000;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'Big-IP i2000',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_i4000;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'Big-IP i4000',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_i4000;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'Big-IP i4000',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_i5000;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'Big-IP i5000',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_i5000;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'Big-IP i5000',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_i7000;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'Big-IP i7000',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_i7000;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'Big-IP i7000',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_i10000;hasEars=0;isFront=1;isDC=0;psNum=1;`,
			168,
			16,
			'',
			'Big-IP i10000',
		...
		sb.createVertexTemplateEntry(
			`${stencilPath}shape=mxgraph.rackF5Shapes.big_ip_i10000;hasEars=1;isFront=0;isDC=1;psNum=2;`,
			168,
			16,
			'',
			'Big-IP i10000',
