 ...
 */
{
	...
	this.layout = new mxWebColaAdaptor(
		this.graph,
		this.graph.pageVisible ? [ps.width, ps.height] : [800, 800],
		movableVertices
	)
	var initial = true
	...
	var _finalLayout = this.computePositions(this.layout)
}
...
mxWebColaLayout.prototype.resetGraph = (graph) =>
	/**
...
mxWebColaLayout.prototype.adjustChildOffsets = function (
	model,
	groupCell,
	_isUndoable,
	_isInitial
 ...
 */
{
	...
	var _spanX = maxX - minX
	var _spanY = maxY - minY
