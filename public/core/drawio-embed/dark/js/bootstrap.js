...
function mxscript(src, onLoad, id, dataAppKey, noWrite, onError) {
	if (
		(urlParams.dev !== '1' && typeof document.createElement('canvas').getContext === 'function') ||
		onLoad != null ||
		noWrite
	) {
...
try {
	_isLocalStorage = urlParams.local !== '1' && typeof localStorage !== 'undefined'
} catch (_e) {
	// ignored
}
