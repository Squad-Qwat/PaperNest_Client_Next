...
Draw.loadPlugin((ui) => {
	...
	function importFreemindData(data) {
		...
		var freeMindMainConceptVertexStyle =
		...
		var freeMindEdgeStyle =
			'edgeStyle=entityRelationEdgeStyle;startArrow=none;endArrow=none;segment=10;curved=1;html=1;'
		...
		var generatePreprocessingNodeInfo = (node) => {
			var childCount = 0
		...
		var processFreeMindNode = (node, nodeParent, x, y) => {
			...
			var nodeVertex = graph.insertVertex(
				defaultParent,
				null,
				nodeName,
				x,
	...
	// Adds action
	ui.actions.addAction('importFreemind...', () => {
	...
	// Adds menu
	ui.menubar.addMenu('Import', (menu, _parent) => {
