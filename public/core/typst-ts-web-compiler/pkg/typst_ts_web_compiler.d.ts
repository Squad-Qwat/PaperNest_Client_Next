...
export class TypstCompiler {
	...
	compile(
		main_file_path: string | null | undefined,
		inputs: Array<any>[] | null | undefined,
		fmt: string,
		diagnostics_format: number
	): any
	query(
...
export interface InitOutput {
	...
	readonly typstcompilerbuilder_set_access_model: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstfontresolverbuilder_add_lazy_font: (
		a: number,
		b: number,
		c: number,
		d: number
	...
	readonly typstcompiler_add_source: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstcompiler_map_shadow: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstcompiler_get_semantic_tokens: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstcompiler_snapshot: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstcompiler_get_artifact: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstcompiler_compile: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstcompiler_incr_compile: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstcompileworld_query: (
		a: number,
		b: number,
		c: number,
		d: number,
