...
export class TypstRenderer {
	...
	render_page_to_canvas(
		ses: RenderSession,
		canvas: any,
		options?: RenderPageImageOptions | null
	): Promise<any>
...
export class TypstWorker {
	...
	render_canvas(
		_actions: Uint8Array,
		_canvas_list: HTMLCanvasElement[],
		_data: RenderPageImageOptions[]
	): Promise<any>
}
...
export interface InitOutput {
	...
	readonly typstrenderer_manipulate_data: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstrenderer_session_from_artifact: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rendersession_render_in_window: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstrenderer_render_svg_diff: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstworker_manipulate_data: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstworker_render_canvas: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly typstrenderer_render_page_to_canvas: (
		a: number,
		b: number,
		c: number,
		d: number
	...
	readonly incrdomdocclient_relayout: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly incrdomdocclient_need_repaint: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly incrdomdocclient_repaint: (
		a: number,
		b: number,
		c: number,
		d: number,
